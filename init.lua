...
if vim.g.vscode then
  ...
  -- workbench
  vim.keymap.set({ "n", "v" }, "<leader>ca", workbench.quickFix)
  vim.keymap.set({ "n", "v" }, "<leader>cA", workbench.showCommands)
  ...
  vim.keymap.set({ "n", "v" }, "<C-`>", toggle.toggleTerminal)

  -- error
  vim.keymap.set({ "n" }, "<leader>sd", error.list)
